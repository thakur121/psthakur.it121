...
@Component({
  selector: 'app-update-vehical-de',
  templateUrl: './update-vehical-de.page.html',
  styleUrls: ['./update-vehical-de.page.scss'],
})
export class UpdateVehicalDePage implements OnInit {
	...
	servicedata:any = [];
      ...
      Loaddatafun()
      {
            let user = JSON.parse(localStorage.getItem('Driverdata'));
            let workdata=JSON.parse(localStorage.getItem('Profile_data'));
            this.userdata.id=user.id;
            this.userdata.ragistration_cer=workdata.vehicle_details.vehicle_plate_number;
            this.userdata.car_number=workdata.vehicle_details.vehicle_registration_number;
            this.userdata.car_brands=workdata.vehicle_details.vehicle_brand;
            this.userdata.car_model=workdata.vehicle_details.vehicle_modal;
            this.userdata.car_color=workdata.vehicle_details.vehicle_color;
            this.userdata.car_image=workdata.vehicle_details.vehicle_document[0].document_url;
            this.userdata.f_reg_image=workdata.vehicle_details.vehicle_document[1].document_url;
            this.userdata.b_reg_image=workdata.vehicle_details.vehicle_document[2].document_url;
            this.userdata.f_num_plate_image=workdata.vehicle_details.vehicle_document[3].document_url;
            this.userdata.b_num_plate_image=workdata.vehicle_details.vehicle_document[4].document_url;
      }
      ...
      chnagefunction(correctPath, currentName)
      {
            ...
            if(this.image_type==1)
            {
            	this.userdata.car_image= this.showimg;
            }
            else if(this.image_type==2)
            {
		...
		var options =
		{
            ...
            fileTransfer.upload(targetPath, url, options).then(res => 
            {
            	...
            	this.rest.presentToast(data.message);
                  ...
                  if(this.image_type==1)
                  {
                        this.userdata.car_image= data.data.url;
                  }
                  else if(this.image_type==2)
                  {
                        this.userdata.f_reg_image= data.data.url;  
                  }
                  else if(this.image_type==3)
                  {
                        this.userdata.b_reg_image= data.data.url;  
                  }
                  else if(this.image_type==4)
                  {
                        this.userdata.f_num_plate_image= data.data.url;
                  }
                  else
                  {
                        this.userdata.b_num_plate_image= data.data.url;  
                  }
            }, err => 
            { 
      ...
      gotoproducydtl()
      {
            if (this.userdata.ragistration_cer=='') 
            {
                  this.rest.presentToast("Please enter your date of birth");
            }
            else if (this.userdata.car_number =='') 
            {
                  this.rest.presentToast("Please Select your Gender");
            }
            else if (this.userdata.car_brands =='') 
            {
                  this.rest.presentToast("Please enter your Bio");
            }
            else if (this.userdata.car_model =='') 
            {
                  this.rest.presentToast("Please enter your Bio");
            }
            else if (this.userdata.car_color =='') 
            {
                  this.rest.presentToast("Please enter your Bio");
            }
			...
			this.servicedata.push({"vehicle_registration_number":  this.userdata.ragistration_cer});
			this.servicedata.push({"vehicle_plate_number":  this.userdata.car_number});
			this.servicedata.push({"vehicle_brand":  this.userdata.car_brands});
			this.servicedata.push({"vehicle_modal":  this.userdata.car_model});
			this.servicedata.push({"vehicle_color":   this.userdata.car_color});
